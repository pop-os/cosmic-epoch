...
While the packages like `cosmic-session`, etc might be present before
NixOS 25.05, the NixOS modules--which handle adding all COSMIC packages to your
NixOS system--were only added during the release of **NixOS 25.05**.
